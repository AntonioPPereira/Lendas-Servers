...
import { EmptyState, ErrorState, LoadingState, SkeletonRows, SlowLoading } from "@/components/ui/States";
      ...
      {period ? (
        ...
        <Panel flush className="overflow-hidden">
          ...
          {resource.status === "error" ? (
            ...
            /* Ler o acervo abre uma conexão SFTP e, se o backend estava
               hibernando, ainda soma o tempo de acordar. Um esqueleto parado
               dezenas de segundos lê como travado — o texto diz o que está
